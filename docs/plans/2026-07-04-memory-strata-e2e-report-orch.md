...
| **end-to-end accuracy** (correct + correct-refusal) | **69.0%** |
...
| **false-refusal rate** (refused an answerable — missed retrieval) | 9.6% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| multi-session | 30 | 43.3% | 0.0% |
| single-session-user | 70 | 80.0% | 0.0% |
