...
**Sampling:** --ids 15 id(s) (filtered, corpus-order) -> temporal-reasoning=7 knowledge-update=3 multi-session=3 single-session-preference=2
**Cost cap:** $3
**Total spent:** $1.3103
**Command:** `pnpm --filter @ax/memory-strata bench --mode e2e --sample 100 --orchestrator-model glm --concurrency 4 --ids 0a995998,88432d0a,32260d93,d24813b1,91b15a6e,gpt4_7f6b06db,9a707b81,gpt4_4fc4f797,gpt4_e061b84f,6e984301,c9f37c46,gpt4_93159ced_abs,6a1eabeb,4b24c848,a2f3aa27`
...
| **end-to-end accuracy** (correct + correct-refusal) | **20.0%** |
| uncertain (judge couldn't tell) | 0.0% |
| avg haystack sessions ingested / question | 46.9 |
| avg memory tool calls / question | 2.2 |
...
| **false-refusal rate** (refused an answerable — missed retrieval) | 7.1% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| knowledge-update | 3 | 33.3% | 0.0% |
| multi-session | 3 | 0.0% | 0.0% |
| single-session-preference | 2 | 50.0% | 0.0% |
| temporal-reasoning | 7 | 14.3% | 0.0% |
