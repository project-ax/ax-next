...
| **end-to-end accuracy** (correct + correct-refusal) | **71.1%** |
...
| **false-refusal rate** (refused an answerable — missed retrieval) | 14.3% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| multi-session | 29 | 51.7% | 0.0% |
| single-session-user | 68 | 79.4% | 0.0% |
