...
|---|---|---|---|---|---|---|---|---|
| longmemeval-s | E: Orchestrator + BM25 fallback | 150 | 52.0% | 89.3% | 0.0% | 891 | 2469 | $7.8519 |

## Abstention

| corpus | Config | unanswerable n | correct-refusal | hallucinated | false-refusal (on answerable) |
|---|---|---|---|---|---|
| longmemeval-s | E: Orchestrator + BM25 fallback | 7 | 6 (85.7%) | 1 | 44 / 143 |

## Spend by model

| model | tokens in | tokens out | $ | % of run |
|---|---|---|---|---|
| `claude-sonnet-4-6` | 2,405,599 | 24,716 | $7.5875 | 96.6% |
| `x-ai/grok-4.3` | 86,667 | 42,613 | $0.2149 | 2.7% |
| `z-ai/glm-5.3-flash:nitro` | 311,528 | 5,499 | $0.0495 | 0.6% |
...
|---|---|---|---|---|---|---|
| longmemeval-s | E: Orchestrator + BM25 fallback | 150 | 2.98 | 0.0% | 37.3% | 27.3% |
