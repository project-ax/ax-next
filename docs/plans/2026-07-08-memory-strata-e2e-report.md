...
| **end-to-end accuracy** (correct + correct-refusal) | **73.0%** |
...
| **correct-refusal rate** (refused when it should) | 66.7% |
| **hallucination rate** (answered an unanswerable) | 33.3% |
| answerable questions | 94 |
| **false-refusal rate** (refused an answerable — missed retrieval) | 11.7% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| multi-session | 30 | 53.3% | 0.0% |
| single-session-user | 70 | 81.4% | 0.0% |
