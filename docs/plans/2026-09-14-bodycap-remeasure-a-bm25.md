...
|---|---|---|---|---|---|---|---|---|
| longmemeval-s | A: BM25-only | 150 | 30.7% | 35.3% | 0.0% | 190 | 560 | $14.2667 |

## Abstention

| corpus | Config | unanswerable n | correct-refusal | hallucinated | false-refusal (on answerable) |
|---|---|---|---|---|---|
| longmemeval-s | A: BM25-only | 7 | 5 (71.4%) | 2 | 72 / 143 |

## Spend by model

| model | tokens in | tokens out | $ | % of run |
|---|---|---|---|---|
| `claude-sonnet-4-6` | 4,504,527 | 33,876 | $14.0217 | 98.3% |
| `x-ai/grok-4.3` | 94,927 | 50,525 | $0.2450 | 1.7% |
