...
**Cost cap:** $200
**Total spent:** $24.7523
**Command:** `pnpm --filter @ax/memory-strata bench --mode e2e --sample 500 --types single-session-assistant`

## Headline

| metric | value |
|---|---|
| questions evaluated | 56 |
| **end-to-end accuracy** (correct + correct-refusal) | **87.5%** |
| uncertain (judge couldn't tell) | 0.0% |
| avg haystack sessions ingested / question | 48.7 |
| avg memory tool calls / question | 1.5 |
...
| answerable questions | 56 |
| **false-refusal rate** (refused an answerable — missed retrieval) | 12.5% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| single-session-assistant | 56 | 87.5% | 0.0% |
