...
**Cost cap:** $60
**Total spent:** $7.2807
**Command:** `pnpm --filter @ax/memory-strata bench --mode e2e --sample 100 --orchestrator-model glm --concurrency 4`
...
| avg haystack sessions ingested / question | 47.8 |
| avg memory tool calls / question | 2.0 |
...
| **correct-refusal rate** (refused when it should) | 80.0% |
| **hallucination rate** (answered an unanswerable) | 20.0% |
| answerable questions | 95 |
| **false-refusal rate** (refused an answerable — missed retrieval) | 9.5% |

## By question type

| question_type | n | accuracy | uncertain% |
|---|---|---|---|
| knowledge-update | 15 | 80.0% | 0.0% |
| multi-session | 27 | 85.2% | 0.0% |
| single-session-assistant | 11 | 63.6% | 0.0% |
| single-session-preference | 6 | 66.7% | 0.0% |
| single-session-user | 14 | 100.0% | 0.0% |
| temporal-reasoning | 27 | 59.3% | 0.0% |
