...
- The workspace symlink points narrowly at `<workspace>/.claude/skills → <workspace>/.ax/skills`; the parent `<workspace>/.claude/` is the workspace's own directory, agent-writable only at paths the validator allows.
