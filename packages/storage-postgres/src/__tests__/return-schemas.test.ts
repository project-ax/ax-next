...
// ARCH-13 drift guard for the data-returning storage:* hooks (postgres peer of
// @ax/storage-sqlite — structurally identical, the I2 two-backend pattern).

describe('storage-postgres return schemas', () => {
